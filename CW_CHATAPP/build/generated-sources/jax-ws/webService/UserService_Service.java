 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "http://services.chatapp.com/", wsdlLocation = "http://localhost:8080/chatapp_ws/UserService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICE_QNAME = new QName("http://services.chatapp.com/", "UserService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/chatapp_ws/UserService?wsdl");
    ...
    public UserService getUserServicePort() {
        return super.getPort(new QName("http://services.chatapp.com/", "UserServicePort"), UserService.class);
    }
    ...
    public UserService getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.chatapp.com/", "UserServicePort"), UserService.class, features);
    }
