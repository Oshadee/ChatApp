 ...
 * 
 */
@WebServiceClient(name = "ChatService", targetNamespace = "http://services.chatapp.com/", wsdlLocation = "http://localhost:8080/chatapp_ws/ChatService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CHATSERVICE_QNAME = new QName("http://services.chatapp.com/", "ChatService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/chatapp_ws/ChatService?wsdl");
    ...
    public ChatService getChatServicePort() {
        return super.getPort(new QName("http://services.chatapp.com/", "ChatServicePort"), ChatService.class);
    }
    ...
    public ChatService getChatServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.chatapp.com/", "ChatServicePort"), ChatService.class, features);
    }
